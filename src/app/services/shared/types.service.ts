...
export class TypesService {
  ...
  getTypes(types:any[]):PokemonType {
    ...
    return new PokemonType(strong, weak, effective, half, invulnerable);
  }

  removeOddTypes(types1:PokemonType, types2:PokemonType){
    ...
    return new PokemonType(teamStrong, teamWeak, teamEffective, teamHalf, teamInvulnerable);
