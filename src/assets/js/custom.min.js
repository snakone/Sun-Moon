...
function closeSideBar() {
    $(function() {
        "use strict";
        (window.innerWidth > 0 ? window.innerWidth : this.screen.width) < 1170 && ($("body").removeClass("show-sidebar"), 
...
function init_plugins() {
    closeSideBar(), $(function() {
        ...
        var i = function() {
            (window.innerWidth > 0 ? window.innerWidth : this.screen.width) < 1170 ? ($("body").addClass("mini-sidebar"), $("body").hasClass("show-sidebar") && $(".nav-toggler i").addClass("ti-close"), $(".sidebartoggler i").addClass("ti-menu")) : $("body").removeClass("mini-sidebar");
            var i = (window.innerHeight > 0 ? window.innerHeight : this.screen.height) - 1;
            (i -= 0) < 1 && (i = 1), i > 0 && $(".page-wrapper").css("min-height", i + "px")
        };
        $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
            $("body").hasClass("mini-sidebar") ? ($("body").trigger("resize"), $("body").removeClass("mini-sidebar")) : ($("body").trigger("resize"), $("body").addClass("mini-sidebar"))
